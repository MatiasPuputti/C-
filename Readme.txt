...
Projects made for school courses:
Teht1-4
NoppaPeli
Palindromi_harj
...
Kansioden_koko			(To get steam folder size faster.)
String_match_checker		(Simple console program that i made for comparing check sums against one another.)
